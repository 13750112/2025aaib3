///week05-3c.cpp 三合一的Part 1/Part 2 Input/Output
///Part 3: stringstream 斷字
/// CPE這次的第2題 UVA 483 Word Scranble 把字弄反
#include <iostream>
#include <sstream> ///Part 3: stringstream 把字串用來斷字
#include <string>
...
int main ()
{
    ...
    ///讀入1行 一直讀,讀到Ctrl-z才結束
        stringstream ss(line); ///Part 3: stringstream 把字串用來斷字
        string word; ///用來斷字囉
        ss >> word; ///Part 5: 解決空格問題,火車頭「不用空格」
        reverse( word.begin(), word.end() );
        cout << word; ///Part 5: 解決空格問題,火車頭「不用空格」
        while( ss >> word ){ ///Part 3: stringstream 把字串用來斷字
